...
public class EntityArrays {
	...
	public static String[][] BASIC_ESCAPE() {
		return Arrays.clone(BASIC_ESCAPE);
	}
	...
	public static String[][] BASIC_UNESCAPE() {
		return Arrays.clone(BASIC_UNESCAPE);
	}
	...
	public static String[][] HTML40_EXTENDED_ESCAPE() {
		return Arrays.clone(HTML40_EXTENDED_ESCAPE);
	}
	...
	public static String[][] HTML40_EXTENDED_UNESCAPE() {
		return Arrays.clone(HTML40_EXTENDED_UNESCAPE);
	}
	...
	public static String[][] ISO8859_1_ESCAPE() {
		return Arrays.clone(ISO8859_1_ESCAPE);
	}
	...
	public static String[][] ISO8859_1_UNESCAPE() {
		return Arrays.clone(ISO8859_1_UNESCAPE);
	}
}
