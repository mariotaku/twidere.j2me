...
public interface KuixConstants {
	...
	public static final String PROGRESS_BAR_WIDGET_TAG = "progressbar";
	public static final String PROGRESS_BAR_PROGRESS_WIDGET_TAG = "progressbarprogress";
	public static final String SEEK_BAR_WIDGET_TAG = "seekbar";
	public static final String SEEK_BAR_PROGRESS_WIDGET_TAG = "seekbarprogress";
	public static final String SEEK_BAR_HANDLE_WIDGET_TAG = "seekbarhandle";
