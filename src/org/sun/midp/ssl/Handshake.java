...
import org.sun.midp.crypto.*;

import org.sun.midp.pki.*;
...
class Handshake {
	 ...
	 * the record layer
	 */
	private void sendHello3() throws IOException {
	 ...
	 */
	private int receiveCert() throws IOException {
		int msgLength;
		int endOfMsg;
		int idx;
		int len;
	 ...
	 */
	private void makeMaster() throws IOException {
		byte[] expansion[] = {
			{(byte) 0x41}, // 'A'
	 ...
	 * record layer
	 */
	private void sendChangeCipher() throws IOException {
		byte[] msg = new byte[1];
	 ...
	 * message
	 */
	private int receiveChangeCipher() throws IOException {
		/* 
	 ...
	 * message
	 */
	private int receiveFinished() throws IOException {
