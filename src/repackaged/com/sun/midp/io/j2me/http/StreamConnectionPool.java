/*
 * @(#)StreamConnectionPool.java	1.17 02/09/16 @(#)
 *
 * Copyright (c) 2001-2002 Sun Microsystems, Inc.  All rights reserved.
 * PROPRIETARY/CONFIDENTIAL
 * Use is subject to license terms.
 */
package repackaged.com.sun.midp.io.j2me.http;
 ...
 *
 */
public final class StreamConnectionPool {
	 ...
	 */
	public StreamConnectionPool(int number_of_connections,
	 ...
	 */
	public synchronized boolean add(String p_protocol,
	 ...
	 */
	public synchronized void remove(StreamConnectionElement sce) {
		sce.close();
		m_connections.removeElement(sce);
	}
	 ...
	 *                              null if not found
	 */
	public synchronized StreamConnectionElement get(String p_protocol, String p_host,
			int p_port) {
	 ...
	 */
	public synchronized void returnForReuse(StreamConnectionElement returned) {
